...
-- BetterWalkMovement: snappier walk/sprint, less "gliding" ramp-up/down.
-- Stock values: 1.8 / 5 / 4.5 / 13 / 500 / smoothing(10,1).
local movementSpeedNormal = 3.2
local movementSpeedSprint = 9

local maxAllowedBallAVNormal = 8 --14
local maxAllowedBallAVSprint = 23 --14
local maxBallTorque = 950
